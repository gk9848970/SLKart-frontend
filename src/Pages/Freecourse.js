...
import Tabbs2 from "../components/Tabbs2";
...
const Freecourse = () => {
  ...
  async function productItems() {
    ...
    const detailsAll = await axios.get(
      `http://35.244.8.93:5011/api/users/product/${id}?institute=${userdata.user_inst_id}`,
      config
    );
  ...
  async function LatestCourseAi() {
    const productDatas = await axios.post(
      `http://35.244.8.93:5011/api/users/product/latestCourse`,
      {
    ...
    <div>
      ...
      <div className="course containermanual course-div">
        <div style={{ flex: "75%" }}>
          ...
          <div className="mb-2 mobile-latest">
            {" "}
            <div>
              <p>
                ₹
                ...
                <span>
                  <b>
                    {detailss.discount != 0
                      ? detailss.price - detailss.discount
                      : detailss.price}
                  </b>
                </span>
              </p>
          ...
          <div>
            <Tabbs2 detail={detailss} playVideo={playVideo} />
          </div>
          <div className="mt-2 mobile-latest">
            <center>
                  ...
                  {productData.map(function (productItem) {
                    ...
                    />{" "}
                          ...
                          <div className="d-flex align-items-center">
                            ...
                            <div className="ms-1">
                              <b>
                                {Number(productItem.course_rating).toFixed(2)}
                              </b>
                            </div>
                          </div>
                          <div
        ...
        <div style={{ flex: "25%" }}>
          <div className="desktop-latest">
            {<PriceCard ids={id} detailss={detailss} />}
          </div>
